...
- [x] Task: Perform a full E2E test: Admin creates a "Limited Time" coupon -> User applies it -> Booking created with discount -> Coupon usage count increments.
- [x] Task: Verify usage limits block subsequent attempts (if limit is 1).
