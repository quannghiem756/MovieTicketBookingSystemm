...
## Phase 2: Node.js Backend Integration [checkpoint: 020298b]
- [x] Task: Write failing tests for the `VectorSyncService` utility in `backend/src/tests/vectorSyncService.test.js`. [020298b]
- [x] Task: Create `VectorSyncService` utility in the Node.js backend to handle API calls to the Python service. [020298b]
- [x] Task: Integrate `VectorSyncService` into `MovieService` for create, update, and delete operations. [020298b]
- [x] Task: Write unit tests to verify `MovieService` calls the sync utility correctly. [020298b]
