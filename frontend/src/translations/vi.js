...
const vi = {
  ...
  'admin.users.table.isVerified': 'Xác thực',
  'admin.users.table.actions': 'Hành động',
  'admin.users.delete': 'Xóa',
  'admin.users.verify': 'Xác thực',
  'admin.users.unverified': 'Chưa xác thực',
  'admin.users.verified': 'Đã xác thực',
  'admin.users.verifyConfirm': 'Xác nhận xác thực',
  'admin.users.verifyMessage': 'Bạn có chắc chắn muốn xác thực tài khoản cho',
  'admin.users.verifySuccess': 'Xác thực tài khoản thành công',
  'admin.users.verifyError': 'Xác thực tài khoản thất bại',
